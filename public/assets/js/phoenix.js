  ...
  const wizardInit = () => {
    ...
    wizards.forEach(wizard => {
      ...
      nextButton.addEventListener(events.CLICK, () => {
        ...
        var total_account_equipement = document.getElementById("total_account_equipement").innerText;
        ...
        var cout_global_total = parseFloat(total_account_product) +
                                ...
                                parseFloat(total_account_equipement) +
                                parseFloat(observation_montant)

        document.getElementById("cout_global_product").innerText = total_account_product;
        document.getElementById("cout_global_acte").innerText = total_account_acte;
        document.getElementById("cout_global_equipement").innerText = total_account_equipement;
        document.getElementById("cout_global_observation").innerText = observation_montant;
        document.getElementById("cout_global_total").innerText = cout_global_total;
        // alert(total_account_product);
        tabs[count + 1].show();
      });
