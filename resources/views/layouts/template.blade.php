    ...
    <script>
        ...
        function selectProduct(i, table){
            if( $("#check_"+table+i).is(':checked') ){
                ...
                if(table == 'product'){
                    ...
                    total_account_eq = total_account_eq - parseFloat( $("#total_"+table+i).text());
                    $("#total_account_"+table).text(total_account_act);
                }
        ...
        function setPrice(i, table){
            ...
            if(table == 'product'){
                ...
                quantity_equipement[i] = quantity_price;
                $("#quantity_"+table).val(quantity_equipement);
            }
            ...
            if(!quantity_price){
                ...
                if(table == 'product'){
                    ...
                    total_account_eq = total_account_eq + parseFloat(price_pvp);
                    $("#total_account_"+table).text(total_account_eq);
                }
