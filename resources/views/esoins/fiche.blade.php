                      ...
                      <tbody class="list">
                        ...
                        <tr>
                          ...
                          <td class="align-middle" style="width:17%">
                            ...
                            @else
                                <h6 class="mb-0">{{ floatval($equipement->unit_cost_drd)*1 }}</h6>
                            @endif
                        ...
                        <?php
                            if(count($quantity_eq)>0 && $i<count($quantity_eq))
                            {
                                $total_eq = $total_eq + floatval($equipement->unit_cost_drd) * floatval($quantity_eq[$i]); $quantity_equipement = $quantity_equipement + $quantity_eq[$i];
                            }
                            else {
                                $total_eq = $total_eq + floatval($equipement->unit_cost_drd)*1; $quantity_equipement = $quantity_equipement + 1;
                            }
                        ?>
                        <?php $i++; ?>
                        @endforeach
