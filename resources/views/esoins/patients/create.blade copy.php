                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                @foreach ($structures as $structure )
                                    <div class="form-check">
                                        <input class="form-check-input" id="village_patient_bouna{{ $structure->id }}" type="radio" name="village_patient" name="village_patient" value="{{ $structure->id }}" />
                                        <label class="form-check-label mb-0" for="village_patient_bouna{{ $structure->id }}">{{ $structure->nom_structure }}</label>
                                    </div>
                                @endforeach
                                <div class="form-check">
                                    <input class="form-check-input" id="village_patient_hors" type="radio" name="village_patient" value="hors zone" />
                                    <label class="form-check-label mb-0" for="village_patient_hors">| Hors Zone |</label>
                                </div>
                            </div>
                            <div class="mb-3">
