                        ...
                        <div class="card theme-wizard mb-5" data-theme-wizard="data-theme-wizard">
                            ...
                            <ul class="nav justify-content-between nav-wizard">
                                <li class="nav-item"><a class="nav-link active fw-semi-bold" href="#bootstrap-wizard-validation-tab1" data-bs-toggle="tab" data-wizard-step="1">
                                    <div class="text-center d-inline-block"><span class="nav-item-circle-parent"><span class="nav-item-circle"><span class="fas fa-lock"></span></span></span><span class="d-none d-md-block mt-1 fs--1">Évacuation</span></div>
                                </a></li>
                                ...
                                <li class="nav-item"><a class="nav-link fw-semi-bold" href="#bootstrap-wizard-validation-tab3" data-bs-toggle="tab" data-wizard-step="3">
                                    <div class="text-center d-inline-block"><span class="nav-item-circle-parent"><span class="nav-item-circle"><span class="fas fa-file-alt"></span></span></span><span class="d-none d-md-block mt-1 fs--1">Consommables</span></div>
                                </a></li>
                                ...
                                <li class="nav-item"><a class="nav-link fw-semi-bold" href="#bootstrap-wizard-validation-tab5" data-bs-toggle="tab" data-wizard-step="5">
                                    <div class="text-center d-inline-block"><span class="nav-item-circle-parent"><span class="nav-item-circle"><span class="fas fa-check"></span></span></span><span class="d-none d-md-block mt-1 fs--1">Hospitalisation</span></div>
                                </a></li>
                                <li class="nav-item"><a class="nav-link fw-semi-bold" href="#bootstrap-wizard-validation-tab6" data-bs-toggle="tab" data-wizard-step="6">
                                    <div class="text-center d-inline-block"><span class="nav-item-circle-parent"><span class="nav-item-circle"><span class="fas fa-check"></span></span></span><span class="d-none d-md-block mt-1 fs--1">Examen complémentaire</span></div>
                                </a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="patient_type" required="required" value="accouchement intervention obstetrical" />
                                                    <label class="form-check-label mb-0" for="patient_type">Accouchement  et intervention obstétrical</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="patient_type" required="required" value="dépistage lésions précancers" />
                                                ...
                                                <div class="invalid-feedback">Please choose a username.</div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="patient_type" required="required" value="planification familiale" />
                                                    <label class="form-check-label mb-0" for="patient_type">Planification familiale</label>
                                                </div>
                                                <div class="invalid-feedback">Please choose a username.</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label class="col-form-label col-form-label-sm" for="diagnostic">Type de prestation</label>
                                ...
                                <div class="tab-pane" role="tabpanel" aria-labelledby="bootstrap-wizard-validation-tab5" id="bootstrap-wizard-validation-tab5">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3 mt-3">
                                                <div class="mb-3">
                                                    <label class="col-form-label col-form-label-sm" for="label_mise_observation">Est ce que le patient a été mis en observation</label>
                                                    <div class="form-check">
                                                      <input class="form-check-input" id="mise_observation_yes" type="radio" name="mise_observation" value="yes" onclick="afficheForm('mise_observation', 'show_observation_montant');" />
                                                      <label class="form-check-label mb-0" for="mise_observation_yes">Oui</label>
                                                    </div>
                                                    <div class="form-check">
                                                      <input class="form-check-input" id="mise_observation_no" type="radio" name="mise_observation" value="no" onclick="afficheForm('mise_observation', 'show_observation_montant');" />
                                                      <label class="form-check-label mb-0" for="mise_observation_no">Non</label>
                                                    </div>
                                                </div>
                                            </div>
