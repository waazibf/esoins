...
@section('content')
  ...
  <div id="categories" data-list='{"valueNames":["id","user_name","subuser_count","product_count","last_active","slug"],"page":10,"pagination":true}' style="border: 1.5rem solid #ededec; padding: 1rem;">
    ...
    <div class="mb-4 bg-white border-y border-300 mt-2 position-relative top-1">
          ...
          <tbody class="list" id="categories-table-body">
            ...
            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
              ...
              <td class="last_active align-middle white-space-nowrap text-700">
                ...
                <a href="{{ route('users.show', $user->id) }}" class="btn btn-soft-danger btn-sm btn-actions"><span class="text-900 fs-3" data-feather="trash-2"></span></a>
              </td>
            </tr>
            @endforeach
          </tbody>
      ...
      <div class="row align-items-center justify-content-between py-2 pe-0 fs--1">
        <div class="col-auto d-flex">
          <p class="mb-0 d-none d-sm-block me-3 fw-semi-bold text-900" data-list-info="data-list-info"></p><a class="fw-semi-bold" href="#!" data-list-view="*">Tous les utilisateurs<span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span></a><a class="fw-semi-bold d-none" href="#!" data-list-view="less">View Less<span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span></a>
        </div>
        <div class="col-auto d-flex">
